  ...
  <div class="app-layout">
    <aside class="app-layout__left">
      <div class="app-layout__top-bar">
        <span class="app-layout__brand">Skills Manager</span>
        <div class="app-layout__top-actions">
        <button class="app-layout__icon-btn" title="刷新" @click="refresh">
        ...
        <button class="app-layout__icon-btn" title="关于" @click="showAbout = true">
